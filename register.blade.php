        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center  md:px-16 px-0 z-0">
            ...
            <div class="w-full py-6 z-20 m-[50px]">
                ...
                <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <x-forms.text-input id="first_name"
                                    class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-indigo-500"
                        ...
                        <div class="w-full px-3 mb-8">
                            ...
                            <div class="flex">
                                ...
                                <x-forms.text-input id="password_confirmation"
                                    class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-indigo-500"
                                    type="password" placeholder="Confirmation Password" name="password_confirmation"
                    ...
                    <x-primary-button
                        class="bg-primary hover:bg-primary-darker text-white font-semibold rounded-md py-2  px-4 w-full ">
                        <div class="text-[16px] ">
                            {{ __('Sign Up') }}
                        </div>
                    </x-primary-button>
